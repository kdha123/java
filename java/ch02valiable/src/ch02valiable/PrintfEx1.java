...
public class PrintfEx1{
	...
	// static 고정 : 먼저 메모리에 올라가서 자바가 종료될 때까지 메모리의 주소를 그대로 가지고 있다.
	// void 없다. : main() 처리가 다 끝나면 돌려받는 것이 없다. 리턴 타입 - 메서드 앞에만 있는 타입
	// String : 문자열 - 참조형 변수 
	// [] 배열 : 여러개
	...
	public static void main(String[] args) {
		...
		// 나열해준다. 이때 대체문자와 출력할 데이터의 갯수는 같아야한다.
		// %n : 줄바꿈 대체문자
		...
		System.out.printf("finger = [%-5d]%n", finger);
		// 자릿수가 크면 공백문자가 기본인데 0으로 채우려면 %0자리수d 를 사용한다.
